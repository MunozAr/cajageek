...
$type_sys = SYS;
$htmlTitulo = 'Módulo de Tipos de Artículos';
        ...
        switch($btn_op_2){
            ...
            case 'modificar-exe':
                ...
                if($result == 1){
                    ...
                    $msg.= script_redirect('tipo.php',2000);
                }else{
                    $msg = alert_text('danger','Hubo un error, informar a los encargados.');
                }
            break;
        ...
        switch($btn_op_form){
            ...
            case 'modificar-form':
                ...
                foreach($result as $col){
                   $tipo_id = $col['tipo_id'];
                   $tipo_nombre =  $col['tipo_nombre'];
                   $tipo_detalle =  $col['tipo_detalle'];
                }

                $título_form = 'Modificar: <b style="color: #EB2929;"> ID: '.$tipo_id.'/ Nombre: '.$tipo_nombre.'</b>';
