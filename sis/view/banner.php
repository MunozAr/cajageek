          ...
          <div class="obj-form">         
            <div class="section-input">
              <label>Nombre del banner</label>
                <input type="text" class="form-control" name="banner_nombre" required>
            </div>
            <div class="section-input">
              <label>Subir Imagen:</label>
              <input type="file" class="form-control btn-success" name="banner_imagen" id="banner_imagen" accept="image/*" value="" required>
                <small><b>Nota:</b> Medidas recomendadas: 1600x800</small>
            </div>
            <div class="section-input">
              <label>Ingrese Link:</label>
